...
html`
<div class="answer_icon_and_label">
  <span class="answer_icon" style="background: linear-gradient(to bottom, ${answers[statsPlace.isit_answer].fill1}, ${answers[statsPlace.isit_answer].fill2});">
  </span>
...
html`
<div class="answer_icon_and_label">
  <span class="answer_icon" style="background: linear-gradient(to bottom, ${answers[statsPlace.isit_answer].fill1}, ${answers[statsPlace.isit_answer].fill2});"></span>
