...
<div class="answer-icon-and-label">
  <span class="answer-icon" style="background: linear-gradient(to bottom, ${answers[statsPlace.isit_answer].fill1}, ${answers[statsPlace.isit_answer].fill2});">
  </span>
...
html`
<div class="answer-icon-and-label">
  <span class="answer-icon" style="background: linear-gradient(to bottom, ${answers[statsPlace.isit_answer].fill1}, ${answers[statsPlace.isit_answer].fill2});"></span>
